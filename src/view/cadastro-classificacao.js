...
function CadastroClassificação() {
    ...
    if (idParam == null) {
      await axios
        ...
        .then(function (response) {
          mensagemSucesso(`Classificação ${descricao} cadastrado com sucesso!`);
      ...
      await axios
        ...
        .then(function (response) {
          mensagemSucesso(`Classificação ${descricao} alterado com sucesso!`);
          navigate(`/listagem-classificacoes`);
        })
        .catch(function (error) {
          mensagemErro(error.response.data);
  ...
  return (
    <div className='container'>
      <Card title='Cadastro de Classificações'>
        <div className='row'>
...
export default CadastroClassificação;